 ...
 */
public class LegacyCommentsAdapter extends BaseExpandableListAdapter {

    private GetCommentThreads commentThreadPager;
    ...
    private static final String TAG = LegacyCommentsAdapter.class.getSimpleName();


    public LegacyCommentsAdapter(Context context, String videoId, ExpandableListView expandableListView, View commentsProgressBar, View noVideoCommentsView) {
        ...
        try {
            this.commentThreadPager = new GetCommentThreads(videoId);
        ...
        protected void onPostExecute(List<YouTubeCommentThread> newComments) {
            ...
            if (newComments != null) {
                if (newComments.size() > 0) {
                    LegacyCommentsAdapter.this.commentThreadsList.addAll(newComments);
                    LegacyCommentsAdapter.this.notifyDataSetChanged();
                }
